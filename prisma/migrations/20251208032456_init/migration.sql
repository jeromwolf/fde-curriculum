-- CreateEnum
CREATE TYPE "AccessLevel" AS ENUM ('FREE', 'BASIC', 'PRO', 'ENTERPRISE');
...
CREATE TABLE "subscriptions" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "plan" "AccessLevel" NOT NULL DEFAULT 'FREE',
...
-- CreateIndex
CREATE INDEX "progress_weekSlug_idx" ON "progress"("weekSlug");
